...
class InputInvoiceName extends JsonSchemeByAzkadev {

  /// Generate By General Universe Script Dont edit by hand or anything manual
  InputInvoiceName(super.rawData);
  ...
  static Map get defaultData {
    return {"@type":"inputInvoiceName","@return_type":"inputInvoice","name":""};
  }

  /// check data 
  /// if raw data 
  /// - rawData["@type"] == inputInvoiceName
  /// if same return true
  ...
  /// create [InputInvoiceName]
  /// Empty  
  static InputInvoiceName empty() {
    return InputInvoiceName({});
  }
