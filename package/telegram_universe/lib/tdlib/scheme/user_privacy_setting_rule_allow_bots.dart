...
class UserPrivacySettingRuleAllowBots extends JsonSchemeByAzkadev {

  /// Generate By General Universe Script Dont edit by hand or anything manual
  UserPrivacySettingRuleAllowBots(super.rawData);
  ...
  static Map get defaultData {
    return {"@type":"userPrivacySettingRuleAllowBots","@return_type":"userPrivacySettingRule"};
  }

  /// check data 
  /// if raw data 
  /// - rawData["@type"] == userPrivacySettingRuleAllowBots
  /// if same return true
  ...
  /// create [UserPrivacySettingRuleAllowBots]
  /// Empty  
  static UserPrivacySettingRuleAllowBots empty() {
    return UserPrivacySettingRuleAllowBots({});
  }
