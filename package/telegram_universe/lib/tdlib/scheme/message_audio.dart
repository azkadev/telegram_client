...
class MessageAudio extends JsonSchemeByAzkadev {

  /// Generate By  AZKADEV | Azka Axelion Gibran Script Dont edit by hand or anything manual
  MessageAudio(super.rawData);
  ...
  static Map get defaultData {
    return {"@type":"messageAudio","@return_type":"messageContent","audio":{"@type":"audio"},"caption":{"@type":"formattedText"}};
  }

  /// check data 
  /// if raw data 
  /// - rawData["@type"] == messageAudio
  /// if same return true
