...
class EditInlineMessageText extends JsonSchemeByAzkadev {

  /// Generate By  AZKADEV | Azka Axelion Gibran Script Dont edit by hand or anything manual
  EditInlineMessageText(super.rawData);
  ...
  static Map get defaultData {
    return {"@type":"editInlineMessageText","@return_type":"ok","is_tdlib_method":true,"inline_message_id":"","reply_markup":{"@type":"replyMarkup"},"input_message_content":{"@type":"inputMessageContent"}};
  }

  /// check data 
  /// if raw data 
  /// - rawData["@type"] == editInlineMessageText
  /// if same return true
  ...
  /// create [EditInlineMessageText]
  /// Empty  
  static EditInlineMessageText empty() {
    return EditInlineMessageText({});
  }
  ...
  /// Generate By  AZKADEV | Azka Axelion Gibran Script Dont edit by hand or anything manual
  static EditInlineMessageText create({
              bool schemeUtilsIsSetDefaultData = false,

    String special_type = "editInlineMessageText",
    ...
    // EditInlineMessageText editInlineMessageText = EditInlineMessageText({
final Map editInlineMessageText_data_create_json = {
      ...
      "input_message_content": (input_message_content != null)?input_message_content.toJson(): null,
          ...
          editInlineMessageText_data_create_json.removeWhere((key, value) => value == null);

    if (schemeUtilsIsSetDefaultData) {
      defaultData.forEach((key, value) {
        if (editInlineMessageText_data_create_json.containsKey(key) == false) {
          editInlineMessageText_data_create_json[key] = value;
        }
      });
    }
return EditInlineMessageText(editInlineMessageText_data_create_json);
