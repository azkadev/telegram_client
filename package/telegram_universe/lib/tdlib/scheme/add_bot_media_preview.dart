...
class AddBotMediaPreview extends JsonSchemeByAzkadev {

  /// Generate By  AZKADEV | Azka Axelion Gibran Script Dont edit by hand or anything manual
  AddBotMediaPreview(super.rawData);
  ...
  static Map get defaultData {
    return {"@type":"addBotMediaPreview","@return_type":"botMediaPreview","is_tdlib_method":true,"bot_user_id":0,"language_code":"","content":{"@type":"inputStoryContent"}};
  }

  /// check data 
  /// if raw data 
  /// - rawData["@type"] == addBotMediaPreview
  /// if same return true
  ...
  /// create [AddBotMediaPreview]
  /// Empty  
  static AddBotMediaPreview empty() {
    return AddBotMediaPreview({});
  }
