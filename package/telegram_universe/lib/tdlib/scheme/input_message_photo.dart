...
class InputMessagePhoto extends JsonSchemeByAzkadev {

  /// Generate By General Universe Script Dont edit by hand or anything manual
  InputMessagePhoto(super.rawData);
  ...
  static Map get defaultData {
    return {"@type":"inputMessagePhoto","@return_type":"inputMessageContent","photo":{"@type":"inputFile"},"thumbnail":{"@type":"inputThumbnail"},"added_sticker_file_ids":[0],"width":0,"height":0,"caption":{"@type":"formattedText"},"show_caption_above_media":false,"self_destruct_type":{"@type":"messageSelfDestructType"},"has_spoiler":false};
  }

  /// check data 
  /// if raw data 
  /// - rawData["@type"] == inputMessagePhoto
  /// if same return true
  ...
  /// Generate By General Universe Script Dont edit by hand or anything manual
  static InputMessagePhoto create({
              bool schemeUtilsIsSetDefaultData = false,

    String special_type = "inputMessagePhoto",
    ...
    // InputMessagePhoto inputMessagePhoto = InputMessagePhoto({
final Map inputMessagePhoto_data_create_json = {
      ...
      "has_spoiler": has_spoiler,
          ...
          inputMessagePhoto_data_create_json.removeWhere((key, value) => value == null);

    if (schemeUtilsIsSetDefaultData) {
      defaultData.forEach((key, value) {
        if (inputMessagePhoto_data_create_json.containsKey(key) == false) {
          inputMessagePhoto_data_create_json[key] = value;
        }
      });
    }
return InputMessagePhoto(inputMessagePhoto_data_create_json);
