...
class OptionValueBoolean extends JsonSchemeByAzkadev {

  /// Generate By General Universe Script Dont edit by hand or anything manual
  OptionValueBoolean(super.rawData);
  ...
  static Map get defaultData {
    return {"@type":"optionValueBoolean","@return_type":"optionValue","value":false};
  }

  /// check data 
  /// if raw data 
  /// - rawData["@type"] == optionValueBoolean
  /// if same return true
