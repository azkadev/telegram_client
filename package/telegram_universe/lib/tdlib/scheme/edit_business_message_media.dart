...
class EditBusinessMessageMedia extends JsonSchemeByAzkadev {

  /// Generate By General Universe Script Dont edit by hand or anything manual
  EditBusinessMessageMedia(super.rawData);
  ...
  static Map get defaultData {
    return {"@type":"editBusinessMessageMedia","@return_type":"businessMessage","is_tdlib_method":true,"business_connection_id":"","chat_id":0,"message_id":0,"reply_markup":{"@type":"replyMarkup"},"input_message_content":{"@type":"inputMessageContent"}};
  }

  /// check data 
  /// if raw data 
  /// - rawData["@type"] == editBusinessMessageMedia
  /// if same return true
  ...
  /// create [EditBusinessMessageMedia]
  /// Empty  
  static EditBusinessMessageMedia empty() {
    return EditBusinessMessageMedia({});
  }
  ...
  /// Generate By General Universe Script Dont edit by hand or anything manual
  static EditBusinessMessageMedia create({
              bool schemeUtilsIsSetDefaultData = false,

    String special_type = "editBusinessMessageMedia",
    ...
    // EditBusinessMessageMedia editBusinessMessageMedia = EditBusinessMessageMedia({
final Map editBusinessMessageMedia_data_create_json = {
      ...
      "input_message_content": (input_message_content != null)?input_message_content.toJson(): null,
          ...
          editBusinessMessageMedia_data_create_json.removeWhere((key, value) => value == null);

    if (schemeUtilsIsSetDefaultData) {
      defaultData.forEach((key, value) {
        if (editBusinessMessageMedia_data_create_json.containsKey(key) == false) {
          editBusinessMessageMedia_data_create_json[key] = value;
        }
      });
    }
return EditBusinessMessageMedia(editBusinessMessageMedia_data_create_json);
