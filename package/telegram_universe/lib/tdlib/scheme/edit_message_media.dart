...
class EditMessageMedia extends JsonSchemeByAzkadev {

  /// Generate By  AZKADEV | Azka Axelion Gibran Script Dont edit by hand or anything manual
  EditMessageMedia(super.rawData);
  ...
  static Map get defaultData {
    return {"@type":"editMessageMedia","@return_type":"message","is_tdlib_method":true,"chat_id":0,"message_id":0,"reply_markup":{"@type":"replyMarkup"},"input_message_content":{"@type":"inputMessageContent"}};
  }

  /// check data 
  /// if raw data 
  /// - rawData["@type"] == editMessageMedia
  /// if same return true
  ...
  /// create [EditMessageMedia]
  /// Empty  
  static EditMessageMedia empty() {
    return EditMessageMedia({});
  }
  ...
  /// Generate By  AZKADEV | Azka Axelion Gibran Script Dont edit by hand or anything manual
  static EditMessageMedia create({
              bool schemeUtilsIsSetDefaultData = false,

    String special_type = "editMessageMedia",
...
final Map editMessageMedia_data_create_json = {
      ...
      "input_message_content": (input_message_content != null)?input_message_content.toJson(): null,
          ...
          editMessageMedia_data_create_json.removeWhere((key, value) => value == null);

    if (schemeUtilsIsSetDefaultData) {
      defaultData.forEach((key, value) {
        if (editMessageMedia_data_create_json.containsKey(key) == false) {
          editMessageMedia_data_create_json[key] = value;
        }
      });
    }
return EditMessageMedia(editMessageMedia_data_create_json);
